...
from src.modules import fit_B1, get_b0, load_data
...
def process_data(data, time_steps):
    ...
    # test_B1(data, time_steps[-1], x0=40, x1=26, amp=0.036, a=0.2)
    fit_B1(data, time_steps[-1], B0, fitrange=[26, 68], x0=40, amp=0.036, a=0.2)
